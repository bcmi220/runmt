...
def get_parser():
    ...
    parser.add_argument("--use_noisy_emb", type=bool_flag, default=False,
                        help="Use noisy embedding")
    parser.add_argument("--use_sep_pos_emb", type=bool_flag, default=False,
                        help="Use seperate position embedding")
    ...
    parser.add_argument("--attention_setting", type=str, default="default", choices=["default", "v1", "v2"],
    ...
    parser.add_argument("--rat_smoothing_epsilon", type=float, default=0,
                        help="RAT Smoothing epsilon for RAT")
    ...
    # en-fr|ro: en->ro(en+fr) fr->ro(en+fr)
    parser.add_argument("--rat_steps", type=str, default="",
                        help="Pivot Agreement Translation steps")
    # en-fr|ro: ro(en+fr)->en ro(en+fr)->fr
    parser.add_argument("--rabt_steps", type=str, default="",
                        help="Pivot Agreement Back-translation steps")
    # en-fr-ro
    parser.add_argument("--xbt_steps", type=str, default="",
                        help="Cross Back-translation steps")

    parser.add_argument("--eval_blacklist", type=str, default="",
                        help="Evaluate black list")
    ...
    parser.add_argument("--reset_stopping_criterion", type=bool_flag, default=False,
                        help="Reset the stopping criterion")
    ...
    for _ in range(params.max_epoch):
        ...
        while trainer.n_sentences < trainer.epoch_size:
            ...
            for lang1, lang2, lang3 in shuf_order(params.rat_steps):
                trainer.rat_stepv2(lang1, lang2, lang3, params.lambda_rat, params.rat_smoothing_epsilon)
